...
REAL_EIG_THRESHOLD = getattr(__config__, 'tdscf_uhf_TDPDFT_pick_eig_threshold', 1e-4)
MO_BASE = getattr(__config__, 'MO_BASE', 1)

# Low excitation filter to avoid numerical instability
POSTIVE_EIG_THRESHOLD = getattr(__config__, 'tdscf_uhf_TDPDFT_positive_eig_threshold', 1e-3)
...
class TDHF(TDA):
    ...
    def gen_vind(self, mf):
        #print('Now in tdpdft uhf.py TDHF gen_vind calling gen_tdhf_operation with ',mf)
