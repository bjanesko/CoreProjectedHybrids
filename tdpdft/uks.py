...
class TDPDFTNoHybrid(TDA):
    ...
    def get_vind(self, mf):
        ...
        vresp = pdft_response_functions.pdft_uhf_response(mo_coeff, mo_occ, hermi=1)
...
#dft.uks.UKS.TDPDFT         = dft.uks_symm.UKS.TDPDFT         = lib.class_as_method(TDPDFT)
dft.uks.UKS.TDPDFTNoHybrid = dft.uks_symm.UKS.TDPDFTNoHybrid = lib.class_as_method(TDPDFTNoHybrid)
dft.uks.UKS.TDPDFT         = dft.uks_symm.UKS.TDPDFT         = tdpdft
