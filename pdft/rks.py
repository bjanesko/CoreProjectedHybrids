...
def get_veff(ks, mol=None, dm=None, dm_last=0, vhf_last=0, hermi=1):
    ...
    # BGJ Build the AO projection operators and projected 1pdm 
    # Any place we evaluate an XC contribution from dm, we evaluate and
    # subtract off the corresponding contribution from pdm, and add exact
